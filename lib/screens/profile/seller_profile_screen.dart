...
import 'package:intl/intl.dart'; // Necesitarás agregar intl en pubspec.yaml si quieres formatear fechas, o usa toString() simple
...
class _SellerProfileScreenState extends State<SellerProfileScreen> {
  ...
  void initState() {
    ...
    _reviewsFuture = reviewProvider.getReviewsByUser(widget.sellerId); // Cargar reviews
  }
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                ...
                children: [
                  Hero(
                    ...
                    child: CircleAvatar(
                      ...
                      child: fullAvatarUrl == null ? const Icon(Icons.person, size: 40) : null,
                    ),
                  ),
            ...
            const Divider(thickness: 8, color: Colors.black12), // Separador grueso visual
            const SizedBox(height: 20),
      ...
      builder: (context, snapshot) {
        ...
        if (listings.isEmpty) {
          return const Padding(
            ...
            child: Text("No hay publicaciones activas.", style: TextStyle(color: Colors.grey)),
          );
        }
    ...
    return FutureBuilder<List<UserReviewDto>>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError) {
          return const Padding(padding: EdgeInsets.all(16), child: Text("No se pudieron cargar las reseñas."));
        }
          ...
          return Container(
            ...
            child: Column(
              children: [
                ...
                const Text("Aún no tiene reseñas.", style: TextStyle(color: Colors.grey)),
              ],
            ),
          );
        }
        ...
        return ListView.separated(
          shrinkWrap: true,
          physics: const NeverScrollableScrollPhysics(), // Scrollea con toda la página
          padding: const EdgeInsets.symmetric(horizontal: 16),
