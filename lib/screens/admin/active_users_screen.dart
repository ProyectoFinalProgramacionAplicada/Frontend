...
class _ActiveUsersScreenState extends State<ActiveUsersScreen> {
    ...
    return Scaffold(
      ...
      body: Consumer2<AuthProvider, AdminProvider>(
        builder: (context, auth, provider, child) {
          ...
          final topByRating = provider.topUsersByRating
              .where((u) => u.averageRating > 0)
              .toList();

          if (users.isEmpty) {
            return const Center(
              child: Text('No hay usuarios activos para mostrar'),
            );
          }
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _smallMetric(
                              'Usuarios que publicaron',
                              '$uniqueUsers',
                            ),
                            _smallMetric(
                              'TrueCoins (activas)',
                              totalTrueCoinsActive.toStringAsFixed(2),
                            ),
                            _smallMetric(
                              'Promedio TC por pub',
                              avgTrueCoins.toStringAsFixed(2),
                            ),
                          ],
                        ),
                      ],
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Publicaciones: Activas vs Inactivas',
                          style: Theme.of(context).textTheme.titleLarge,
                        ),
                        const SizedBox(height: 8),
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Distribución de TrueCoins por publicación',
                          style: Theme.of(context).textTheme.titleLarge,
                        ),
                        const SizedBox(height: 8),
                            ...
                            children: topByRating
                                ...
                                .map(
                                  (u) => ListTile(
                                    ...
                                    title: Text(u.displayName),
                                    subtitle: Text(
                                      'Rating: ${u.averageRating.toStringAsFixed(2)} · Publicaciones: ${u.listingCount}',
                                    ),
                                  ),
                                )
                                .toList(),
  ...
  Widget _buildActiveInactiveChart(AdminProvider provider) {
    ...
    return Column(
      ...
      children: [
        Text(
          'Total: $total · Activas: $active · Inactivas: $inactive',
          style: Theme.of(context).textTheme.bodySmall,
        ),
        const SizedBox(height: 8),
        LayoutBuilder(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    SizedBox(
                      width: 48,
                      child: Text('${(activePct * 100).toStringAsFixed(0)}%'),
                    ),
                  ],
                ),
                const SizedBox(height: 8),
                ...
                Row(
                  children: [
                    ...
                    SizedBox(
                      width: 48,
                      child: Text('${(inactivePct * 100).toStringAsFixed(0)}%'),
                    ),
                  ],
                ),
              ],
